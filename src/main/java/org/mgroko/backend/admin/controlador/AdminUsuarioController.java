...
public class AdminUsuarioController {
    ...
    public ResponseEntity<AdminUsuarioResponse> deshabilitar(@PathVariable Long id, Authentication authentication) {
        Long idSolicitante = Long.parseLong((String) authentication.getPrincipal());
        return ResponseEntity.ok(adminUsuarioService.deshabilitar(id, idSolicitante));
    }
}