...
| **Flujo alternativo** | 2.1 | Si el usuario decide iniciar sesión con Google, véase el UC-09 Autenticar mediante Google OAuth |
| **Excepciones** | **Paso** | **Acción** |
|  | 3 | Si el nombre de usuario no existe en la base de datos o la contraseña no coincide, vuelve al paso 1 de la secuencia normal o finaliza el caso de uso. |
|  | 4 | Si el usuario está deshabilitado, el sistema informa al actor y el caso de uso finaliza. |
...
| **Postcondición** | Se dió de alta a un nuevo usuario en el sistema |  |
| **Flujo alternativo** | 2.1 | Si el usuario desea registrarse con Google, véase el UC-09 Autenticar mediante Google OAuth |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 3 | Si ya existe otro usuario con el mismo correo, el sistema informa al actor y vuelve al paso 1 de la secuencia normal o finaliza el caso de uso. |
|  | 2 | Si la fecha de nacimiento ingresada por el usuario da menor a 18 años a la fecha actual del sistema, el sistema notifica la excepción y el caso de uso finaliza |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 3 | 2 segundos |
| **Frecuencia**  | 50 veces/día |  |
| **Estabilidad**  | media |  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El administrador busca y selecciona al usuario a deshabilitar (vea el caso de uso UC-06 Buscar usuario). |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El administrador busca y selecciona al usuario a habilitar (vea el caso de uso UC-06 Buscar usuario). |
|  | 2 | El sistema solicita confirmación. |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El sistema solicita el ingreso de los criterios de filtrado (Nombre, apellido, correo electrónico, estado, perfiles asociados). |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 3 | Si no existen registros que coincidan con los filtros, el sistema notifica al actor y vuelve al paso 1 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 3 | 4 segundos |
...
| **Objetivos asociados**  | OBJ-01 |  |
| **Requisitos asociados**  | IRQ-01  |  |
| **Descripción**  | El caso de uso inicia cuando un usuario solicita la baja su cuenta del sistema. |  |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 3 | Si el usuario deja campos obligatorios vacíos o ingresa una fecha inválida, el sistema notifica la excepción y vuelve al paso 2 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 5 | 2 segundos |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 4 | Si el servicio de Google no responde o el token es inválido, el sistema informa el fallo técnico y el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 4 | 3 segundos |
...
|  | 2 | El sistema solicita datos generales:  Nombre artístico Profesión (ver caso de uso UC-59 Buscar profesiones). |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 5 | Si el usuario deja campos obligatorios vacíos, el sistema notifica la excepción y vuelve al paso 3 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 4 | 2 segundos |
| **Frecuencia**  | 25 veces/día |  |
| **Estabilidad**  | media |  |
| **Comentarios** | En esta primera versión del sistema, las profesiones disponibles son: fotógrafo, modelo, diseñador de moda, productor de moda, maquillador, estilista de cabello y estilista de imágen. |  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El usuario selecciona el perfil que desea editar (ver caso de uso UC-16 Buscar perfil). |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 4 | Si el usuario deja campos obligatorios vacíos, el sistema informa el error y vuelve al paso 2\. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 3 | 2 segundos |
| **Frecuencia**  | 5 veces/día |  |
| **Estabilidad**  | media |  |
...
| **Precondición**  | El usuario debe haber iniciado sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El usuario selecciona el perfil que desea eliminar (ver caso de uso UC-16 Buscar perfil). |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El sistema recupera y lista todos los perfiles asociados a la cuenta del usuario. (ver caso de uso UC-16 Buscar perfil). |
...
| **Precondición**  | El usuario debe haber iniciado sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El usuario localiza el perfil que desea ver (ver caso de uso UC-16 Buscar perfil). |
...
| **Precondición**  | El usuario debe haber iniciado sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El usuario localiza el perfil que desea reportar (ver caso de uso UC-16 Buscar perfil). |
...
| **Precondición**  | El actor debe haber iniciado sesión en el sistema |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El sistema solicita el ingreso de los criterios de filtrado (Nombre, profesión (ver caso de uso UC-59 Buscar profesiones), apellido, nombre artístico, características técnicas, habilidades). |
|  | 2 | El actor ingresa los parámetros de búsqueda. |
...
| **Postcondición** | Se actualizó el calendario del usuario, dejando disponibles el bloque de tiempo (fecha u horarios).  |  |
| **Excepciones** | **Paso** | **Acción** |
|  | 2 | Si el usuario seleccionó alguna fecha o rango horario donde tiene asignada una actividad de un proyecto activo, el sistema notifica al usuario que no puede marcar como disponible un horario comprometido con una actividad y vuelve al paso 1 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 3 | 2 segundos |
| **Frecuencia**  | 10 veces/día |  |
| **Estabilidad**  | media |  |
...
| **Postcondición** | Se registraron días no disponibles en el calendario del usuario, dejando bloqueando esos días para la recepción de ofertas de proyectos.  |  |
| **Excepciones** | **Paso** | **Acción** |
|  | 2 | Si el bloque de tiempo seleccionado por el usuario cuenta con una actividad planificada en un proyecto activo, el sistema informa al usuario que el periodo ya se encuentra bloqueado automáticamente por dicha actividad, omitiendo la creación de un registro duplicado. Se vuelve al paso 1 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 5 | 2 segundos |
| **Frecuencia**  | 10 veces/día |  |
| **Estabilidad**  | media |  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El sistema despliega el formulario de carga solicitando los siguientes datos de manera obligatoria: Archivos multimedia  Título de la publicación Y de forma opcional: Descripción de la publicación Ubicación Proyecto asociado (ver caso de uso UC-29 Buscar proyecto) Invitar colaboradores (ver caso de uso UC-61 Enviar solicitud de colaboración) |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 2 | Si el usuario intenta cargar un archivo no válido o deja el título vacío, el sistema notifica del error y vuelve al paso 1, manteniendo los datos previamente cargados. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 3 | 2 segundos |
...
| **Precondición**  | El usuario debe haber iniciado sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El usuario selecciona la publicación que desea eliminar (Ver caso de uso UC-22 Buscar publicación). |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El usuario selecciona la publicación que desea modificar (ver caso de uso UC-15 Buscar publicación). |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 3 | Si el texto ingresado está vacío o supera el límite de caracteres permitido, el sistema notifica al usuario y vuelve al paso 2\. (permitiendo al usuario corregir el contenido sin perder los cambios previos).  |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 4 | 2 segundos |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto que desea publicar (ver caso de uso UC-29 Buscar proyecto) |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 2 | Si el proyecto tiene incompleta la información básica, el sistema informa al actor y el caso de uso finaliza |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 4 | 2 segundos |
| **Frecuencia**  | 40 veces/día |  |
| **Estabilidad**  | media |  |
| **Comentarios** | La visibilidad dependerá de la privacidad del proyecto. Público: visible para cualquier usuario de la plataforma Privado: visible únicamente para la red de contactos del usuario. |  |
...
| **Precondición**  | El usuario inició sesión en el sistema y tiene un perfil activo con la profesión solicitada en el requerimiento. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El usuario selecciona el requerimiento de actividad del que quiere dar de alta la postulación (ver caso de uso UC-73 Buscar requerimiento actividad) |
|  | 2 | El sistema verifica la disponibilidad del usuario frente al rango factible de la actividad |
|  | 3 | El usuario confirma la acción. |
|  | 4 | El sistema registra un alta de postulación a proyecto. |
| **Postcondición** | Se registró un alta de postulación a un requerimiento asociado a un proyecto. El sistema crea una solicitud de notificación al director de proyecto para que evalúe la postulación. |  |
| **Flujo alternativo** | 1.1 | Si el usuario quiere dar de alta una postulación de un requerimiento general  de proyecto. (ver caso de uso UC-72 Buscar requerimiento general) |
|  | 1.2 | El sistema solicita confirmación y el caso de uso continúa desde el paso 3 |
| **Excepciones** | **Paso** | **Acción** |
|  | 2 | Si el usuario no tiene disponibilidad suficiente, el sistema notifica al usuario el error y el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 2 | 2 segundos |
| **Frecuencia**  | 85 veces/día |  |
| **Estabilidad**  | media |  |
| **Comentarios** | Al postularse a un requerimiento general, el sistema no evalúa la disponibilidad del usuario debido a que no va a cumplir ninguna actividad aún.  |  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El usuario selecciona el proyecto del que quiere dar de baja la postulación (ver caso de uso UC-29 Buscar proyecto) |
|  | 2 | El sistema solicita confirmación. |
|  | 3 | El usuario confirma la acción. |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El usuario selecciona la invitación a proyecto que quiere aceptar (ver caso de uso UC-30 Buscar invitaciones) |
...
|  | 2 | El actor ingresa los parámetros de búsqueda. |
|  | 3 | El sistema consulta el repositorio de proyectos y filtra aquellas que coinciden con los criterios. |
|  | 4 | El sistema lista los resultados obtenidos. |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona la invitación que quiere eliminar (ver caso de uso UC-30 Buscar invitaciones) |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 3 | Si la invitación no está en estado “Pendiente” el sistema notifica al actor y el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 3 | 2 segundos |
...
| **Precondición**  | El usuario ha iniciado sesión en el sistema y tiene o es miembro al menos un proyecto en estado “Borrador”, “Publicado” o “Confirmado”. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto del cual quiere ver el cronograma (ver caso de uso UC-29 Buscar proyecto). El sistema recupera las actividades asociadas al mismo. (ver UC-52 Buscar actividades) |
...
| **Flujo alternativo** | 3.1 | Si el actor selecciona “Rechazar postulación”: |
|  | 3.1.1 | El sistema solicita confirmación. |
|  | 3.1.2 | El actor confirma la acción. |
|  | 3.1.3 | El sistema elimina la postulación y notifica al perfil que su postulación fue rechazada. |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto que quiere cancelar (ver caso de uso UC-29 Buscar proyecto). |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 3 | Si el actor no ingresa el motivo de cancelación, el sistema informa al actor y vuelve al paso 2 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 4 | 2 segundos |
| **Frecuencia**  | 5 veces/día |  |
| **Estabilidad**  | media |  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto que quiere modificar (ver caso de uso UC-29 Buscar proyecto). |
|  | 2 | El sistema despliega un formulario cargando los datos actuales del proyecto. Los datos que el actor no puede modificar son:  Nombre del proyecto Cualquier requerimiento de personal que esté previamente satisfecho. Los datos que puede modificar son:  Descripción del proyecto Privacidad del proyecto (público, privado u oculto) Ubicación Requerimientos de personal: Profesión, aptitudes y cantidad por profesión Moodboard  Objetivos Fecha de entrega final estipulada |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 3 | Si el usuario deja campos obligatorios vacíos, el sistema informa el error y vuelve al paso 2 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 4 | 2 segundos |
| **Frecuencia**  | 30 veces/día |  |
| **Estabilidad**  | media |  |
...
| **Objetivos asociados**  | OBJ-02 |  |
| **Requisitos asociados**  | IRQ-03 |  |
| **Descripción**  | El caso de uso inicia cuando se va a finalizar un proyecto con estado Confirmado. El sistema deberá cambiar el estado del proyecto a Finalizado, notificando a todos los participantes y solicitandoles que califiquen al equipo.  |  |
...
| **Flujo alternativo** | 3.1 | Si el director de proyecto decide subir imágenes del resultado del proyecto, véase el caso de uso “Alta publicación”. Luego el caso de uso continúa desde el paso 5\. |
| **Excepciones** | **Paso** | **Acción** |
|  | 1 | Si el director de proyecto no califica al equipo completo, el sistema informa que es obligatorio para continuar. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 6 | 2 segundos |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto del que quiere eliminar un integrante (ver caso de uso UC-29 Buscar proyecto). |
|  | 2 | El sistema despliega información básica del proyecto. |
|  | 3 | El actor selecciona el perfil del integrante que quiere eliminar (ver caso de uso UC-16 Buscar perfil) |
...
| **Precondición**  | El actor inició sesión en el sistema, el proyecto se encuentra en estado “Publicado” o “Confirmado” y posee al menos un miembro de proyecto. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto del que quiere generar un contrato (ver caso de uso UC-29 Buscar proyecto). |
|  | 2 | El sistema despliega información básica del proyecto. |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 7 | Si algún participante seleccionado ya posee un contrato emitido y activo del mismo tipo para este proyecto, el sistema notifica la excepción y vuelve al paso 3 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 7 | 2 segundos |
| **Frecuencia**  | 5 veces/día |  |
| **Estabilidad**  | media |  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto del que se quiere dar de baja (ver caso de uso UC-29 Buscar proyecto). |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto en el cual quiere mandar un mensaje (ver caso de uso UC-29 Buscar proyecto). |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 4 | Si el texto ingresado supera el límite de caracteres permitido, el sistema notifica al usuario y vuelve al paso 2\. (permitiendo al usuario corregir el contenido sin perder los cambios previos).  |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 4 | 1 segundo |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor localiza al usuario con el que desea comunicarse (ver caso de uso UC-16 Buscar perfil). |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor localiza el perfil del usuario con el que desea conectar (ver caso de uso UC-16 Buscar perfil). |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor, en su red de contactos, localiza el perfil del usuario que desea eliminar (ver caso de uso UC-16 Buscar perfil). |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor localiza la solicitud de conexión que desea gestionar (ver caso de uso UC-46 Buscar solicitudes de conexión). |
...
| **Postcondición** | Se actualizó el estado de la solicitud a “Acetada”.  Se registró una nueva relación de conexión con  fecha de inicio de conexión igual a la fecha actual del sistema. El sistema envía a ambas partes una notificación informando sobre la nueva conexión. |  |
| **Flujo alternativo** | 3.1 | Si el actor selecciona “Rechazar”: |
|  | 3.1.1 | El actor confirma la acción |
|  | 3.1.2 | El sistema registra el rechazo, cambia el estado de la solicitud a “Rechazada” y el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 4 | 2 segundos |
|  | 3.1.2 | 2 segundos |
| **Frecuencia**  | 5 veces/día |  |
...
| **Objetivos asociados**  | OBJ-06 |  |
| **Requisitos asociados**  | IRQ-06 |  |
| **Descripción**  | El caso de uso inicia cuando se va a buscar las solicitudes de conexión asociadas a un perfil de usuario registrado en el sistema. |  |
| **Precondición**  | El usuario debe haber iniciado sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
...
|  | 3 | El actor selecciona la habilidad profesional que desea incorporar a su perfil (ver caso de uso UC-48 Buscar habilidades). |
|  | 4 | El sistema solicita confirmación. |
...
| **Flujo alternativo**  | 2.1 | Si el usuario selecciona “Eliminar habilidad” |
|  | 2.1.1 | El actor, dentro de su catálogo de habilidades del perfil, selecciona la habilidad profesional que desea eliminar (ver caso de uso UC-48 Buscar habilidades). |
|  | 2.1.2 | El sistema solicita confirmación. |
|  | 2.1.3 | El usuario confirma la acción. |
|  | 2.1.4 | El sistema elimina la habilidad de su perfil y el caso de uso finaliza. |
| **Excepciones** | **Paso** | **Acción** |
|  | 5 | Si el usuario ya cuenta con esa habilidad en su perfil, el sistema notifica la excepción y vuelve al paso  |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 6 | 2 segundos |
|  | 2.1.4 | 2 segundos |
| **Frecuencia**  | 30 veces/día |  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto al cual desea agregar la actividad (ver caso de uso UC-29 Buscar proyecto). |
...
|  | 4.a | El sistema despliega el formulario para la carga de requerimiento profesional: Requerimiento profesional necesario: Profesión (ver caso de uso UC-59 Buscar profesiones) Habilidades (si corresponde (ver caso de uso UC-48 Buscar habilidades)) Características técnicas específicas (si corresponde (ver caso de uso UC-58 Buscar características técnicas)) Si corresponde, el sistema despliega debajo de este formulario un listado de los miembros del proyecto, permitiendo al actor la asignación directa.  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona la tarea que desea modificar (ver caso de uso UC-52 Buscar actividades). |
|  | 2 | El sistema despliega un formulario con la información de la actividad: Nombre de la actividad Descripción Duración estimada en días/horas Requerimiento profesional necesario: Profesión (ver caso de uso UC-59 Buscar profesiones) Habilidades (si corresponde (ver caso de uso UC-48 Buscar habilidades)) Características técnicas específicas (si corresponde (ver caso de uso UC-58 Buscar características técnicas)) Profesionales asignados (si corresponde) Actividades predecesoras asociadas (si corresponde (ver caso de uso UC-52 Buscar actividades)) Ubicación  Estado  |
...
| **Flujo alternativo** | 3.1 | Si la modificación del actor genera un retraso que supere la fecha de entrega del proyecto, el sistema registra los cambios, actualiza el estado del cronograma a “Alerta por desborde” y notifica al actor para que se tomen medidas.   |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 3 | Si el actor deja campos obligatorios vacíos o ingresa una duración menor o igual a cero, el sistema informa el error y vuelve al paso 2 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 4 | 2 segundos |
| **Frecuencia**  | 30 veces/día |  |
| **Estabilidad**  | media |  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona la tarea que desea eliminar (ver caso de uso UC-52 Buscar actividades). |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto del que quiere modificar un contrato (ver caso de uso UC-68 Buscar contrato). |
...
|  | 4 | El sistema recupera los datos específicos del contrato: Tipo de acuerdo (cesión de derechos de imagen, préstamo de indumentaria/materiales, entre otros). Miembros del proyecto destinatarios. |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 7 | Si algún participante seleccionado ya posee un contrato emitido y activo del mismo tipo para este proyecto, el sistema notifica la excepción y vuelve al paso 4 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 7 | 2 segundos |
| **Frecuencia**  | 5 veces/día |  |
| **Estabilidad**  | media |  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto del que quiere eliminar un contrato (ver caso de uso UC-68 Buscar contrato). |
|  | 2 | El sistema despliega los contratos con estado “Pendiente de firma” asociados al proyecto |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el proyecto en el cual tiene asociado el contrato a firmar (ver caso de uso UC-68 Buscar contrato). |
...
| **Precondición**  | El usuario inició sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El sistema recupera y despliega todas las habilidades registradas en el sistema (ver caso de uso UC-48 Buscar habilidades) y expone las siguientes opciones: “Agregar nueva habilidad” “Modificar habilidad” “Eliminar habilidad” |
|  | 2 | El actor selecciona “Agregar nueva habilidad”. |
|  | 3 | El sistema despliega un formulario de carga solicitando la siguiente información de forma obligatoria: Nombre de la habilidad Y opcionalmente: Descripción de la habilidad Profesión asociada (ver caso de uso UC-59 buscar profesiones) |
...
| **Flujo alternativo 2.1** | 2.1 | Si el actor selecciona “Modificar habilidad”: |
|  | 2.1.1 | El actor selecciona la habilidad que quiere modificar (ver caso de uso UC-48 Buscar habilidades). |
|  | 2.1.2 | El sistema despliega la información de la habilidad: Nombre Descripción de la habilidad Profesión asociada |
|  | 2.1.3 | El actor modifica los campos deseados y confirma la acción.  |
|  | 2.1.4 | El sistema registra los cambios. |
| **Postcondición 2.1** | Se modificó una habilidad del sistema. El sistema, por cada perfil de usuario que tenía la habilidad asociada a su perfil, emite una notificación informando de la modificación. |  |
| **Flujo alternativo 2.2** | 2.2 | Si el actor selecciona “Eliminar habilidad”: |
|  | 2.2.1 | El actor selecciona la habilidad que quiere eliminar (ver caso de uso UC-48 Buscar habilidades). |
|  | 2.2.2 | El sistema despliega los datos de la habilidad y solicita confirmación. |
|  | 2.2.3 | El actor confirma la acción.  |
|  | 2.2.4 | El sistema registra la baja.  |
| **Postcondición 2.2** | Se dió de baja una habilidad en el sistema.  El sistema, por cada perfil de usuario que tenía la habilidad asociada a su perfil, emite una notificación informando de la baja.  |  |
| **Excepciones** | **Paso** | **Acción** |
|  | 4 | Si el actor deja campos obligatorios vacíos o introduce un nombre de habilidad igual al de otra ya existente en el sistema, el sistema notifica la excepción y vuelve al paso 3 o el caso de uso finaliza.   |
|  | 2.1.3 | Si el actor deja campos obligatorios vacíos o introduce un nombre de habilidad igual al de otra ya existente en el sistema, el sistema notifica la excepción y vuelve al paso 2.1.2 o el caso de uso finaliza.   |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 5 | 2 segundos |
|  | 2.1.4 | 2 segundos |
|  | 2.2.4 | 2 segundos |
...
| **Precondición**  | El usuario inició sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El sistema recupera y despliega todas las características registradas en el sistema (ver caso de uso UC-58 Buscar características técnicas) y expone las siguientes opciones: “Agregar nueva característica” “Modificar característica” “Eliminar característica” |
...
| **Flujo alternativo 2.2** | 2.2 | Si el actor selecciona “Eliminar característica”: |
|  | 2.2.1 | El actor selecciona la característica que quiere eliminar (ver caso de uso UC-58 Buscar características técnicas). |
|  | 2.2.2 | El sistema despliega los datos de la característica y solicita confirmación. |
|  | 2.2.3 | El actor confirma la acción.  |
|  | 2.2.4 | El sistema registra la baja.  |
| **Postcondición 2.2** | Se dió de baja una característica en el sistema.  El sistema, por cada perfil de usuario que tenía la característica asociada a su perfil, emite una notificación informando de la baja.  |  |
| **Excepciones** | **Paso** | **Acción** |
...
|  | 2.1.3 | Si el actor deja campos obligatorios vacíos o introduce un nombre de característica igual al de otra ya existente en el sistema, el sistema notifica la excepción y vuelve al paso 2.1.2 o el caso de uso finaliza.   |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 5 | 2 segundos |
|  | 2.1.4 | 2 segundos |
|  | 2.2.4 | 2 segundos |
...
| **Precondición**  | El actor debe haber iniciado sesión en el sistema |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El sistema solicita el ingreso de los criterios de filtrado (Nombre de la característica, descripción, profesión asociada (ver caso de uso UC-59 Buscar profesiones) (si corresponde)). |
|  | 2 | El actor ingresa los parámetros de búsqueda. |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona el perfil que desea enviar la solicitud (ver caso de uso UC-16 Buscar perfil) |
...
| **Precondición**  | El usuario inició sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona la solicitud que desea aceptar (ver caso de uso UC-65 Buscar solicitudes de colaboración) |
...
| **Precondición**  | El usuario inició sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona la solicitud que desea rechazar (ver caso de uso UC-65 Buscar solicitudes de colaboración) |
|  | 2 | El sistema despliega la información de la solicitud y solicita confirmación. |
|  | 3 | El actor confirma la acción. |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona la solicitud de colaboración que desea eliminar (ver caso de uso UC-65 Buscar solicitudes de colaboración). |
|  | 2 | El sistema despliega la información de la solicitud y solicita confirmación. |
|  | 3 | El actor confirma la acción. |
...
|  | 4 | El sistema recupera las publicaciones asociadas a cada solicitud de colaboración (ver caso de uso UC-22 Buscar publicación) y lista los resultados obtenidos.  |
| **Salida** | El sistema devuelve un listado con las solicitudes de colaboración y con sus publicaciones que cumplen el criterio de búsqueda. |  |
| **Excepciones** | **Paso** | **Acción** |
|  | 3 | Si no existen registros que coincidan con los filtros, el sistema notifica al actor y vuelve al paso 1 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 3 | 2 segundos |
...
| **Precondición**  | El usuario inició sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El actor selecciona la publicación con la que desea interactuar (ver caso de uso UC-22 Buscar publicación) |
...
| **Flujo alternativo**  | 3.1 | Si el actor selecciona ‘Me gusta’. |
|  | 3.2 | El sistema registra la interacción y notifica al dueño de la publicación.  |
| **Postcondición 3.1** | Se registró un nuevo me gusta asociado a una publicación. Se sumó en 1 la cantidad de me gusta de la publicación. El sistema, por cada perfil asociado a la publicación, genera una notificación informando de la nueva interacción.  |  |
| **Excepciones** | **Paso** | **Acción** |
|  | 5 | Si el usuario ingresa texto vacío o supera el límite de caracteres, el sistema informa el error y vuelve al paso 4 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 6 | 2 segundos |
|  | 3.2 | 2 segundos |
| **Frecuencia**  | 40 veces/día |  |
...
| **Excepciones** | **Paso** | **Acción** |
|  | 2 | Si el rango de fechas es inválido, el sistema notifica el error y vuelve al paso 1 o el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 3 | 2 segundos |
| **Frecuencia**  | 10 veces/día |  |
| **Estabilidad**  | media |  |
...
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El sistema solicita el ingreso de al menos un criterio de filtrado (partes del contrato, estado del contrato, fecha de emisión, fecha de firma (si corresponde), proyecto asociado (ver caso de uso UC-29 Buscar proyecto). |
|  | 2 | El actor ingresa los parámetros de búsqueda. |
...
| **Precondición**  | El usuario debe haber iniciado sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El usuario localiza el perfil que desea reportar (ver caso de uso UC-22 Buscar publicación). |
|  | 2 | El sistema despliega un formulario solicitando: Motivo del reporte (categorías predefinidas: spam, contenido inapropiado, identidad falsa, otro) Descripción detallada (opcional) |
|  | 3 | El usuario selecciona el motivo, completa descripción y envía el reporte. |
...
| **Postcondición** | Se registró una asignación de actividad entre el miembro seleccionado y la actividad. El sistema crea una solicitud de notificación al miembro de proyecto. |  |
| **Excepciones** | **Paso** | **Acción** |
|  | 2 | Si el usuario no tiene disponibilidad suficiente, el sistema notifica al actor el error y el caso de uso finaliza. |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 2 | 2 segundos |
| **Frecuencia**  | 85 veces/día |  |
| **Estabilidad**  | media |  |
| **Comentarios** | Si el miembro satisface un requerimiento (ej. cumple con la profesión) el requerimiento ya se cierra. En caso contrario, se le asigna la actividad igualmente. |  |
...
| **Objetivos asociados**  | OBJ-01 OBJ-03 OBJ-04 |  |
| **Requisitos asociados**  | IRQ-05 |  |
| **Descripción**  | El caso de uso inicia cuando un usuario desea configurar su jornada laboral. El sistema le permitirá configurar su jornada de forma personalizada por días.  |  |
| **Precondición**  | El usuario inició sesión en el sistema. |  |
| **Secuencia normal**  | **Paso** | **Acción** |
|  | 1 | El sistema despliega un formulario de carga con una jornada predeterminada. Para modificarla, solicita por día: Jornada partida o completa Si el usuario selecciona jornada partida, el sistema despliega: Horario de inicio por la mañana Horario de fin por la mañana Horario de inicio por la tarde Horario de fin por la tarde Si por el contrario el usuario selecciona jornada completa: Horario inicio Horario fin |
|  | 2 | Mientras existan días por cargar, se repite el paso 3: |
|  | 3 | El usuario selecciona el tipo de jornada e ingresa los horarios correspondientes. |
|  | 4 | El usuario confirma los datos. |
|  | 5 | El sistema valida los datos y registra una nueva jornada laboral asociada al usuario. |
| **Postcondición** | Se registró una jornada laboral y se asoció al calendario del usuario. El sistema crea una solicitud de notificación al usuario para notificar sobre el cambio. |  |
| **Excepciones** | **Paso** | **Acción** |
|  | 5 | Si el usuario ingresa horarios inválidos, el sistema notifica al usuario del error y vuelve al paso 3 o el caso de uso finaliza.  |
|  | 5 | Si el usuario saca de su jornada laboral un día en el que tiene una actividad asignada y el sistema detecta que … |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 5 | 2 segundos |
| **Frecuencia**  | 85 veces/día |  |
| **Estabilidad**  | media |  |
...
|  | 4 | El sistema lista los resultados obtenidos. |
| **Salida** | El sistema devuelve un listado con los requerimientos generales que cumplen con el criterio de búsqueda. |  |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 3 | 2 segundos |
| **Frecuencia**  | 70 veces/día |  |
| **Estabilidad**  | media |  |
...
|  | 4 | El sistema lista los resultados obtenidos. |
| **Salida** | El sistema devuelve un listado con los requerimientos de actividad que cumplen con el criterio de búsqueda. |  |
| **Rendimiento**  | **Paso** | **Cota de tiempo**  |
|  | 3 | 2 segundos |
| **Frecuencia**  | 70 veces/día |  |
| **Estabilidad**  | media |  |
